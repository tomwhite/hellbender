...
public class ReadsPreprocessingPipeline extends DataflowCommandLineProgram {
    ...
    protected void setupPipeline( Pipeline pipeline ) {
        ...
        final ReferenceDataflowSource referenceDataflowSource = new ReferenceDataflowSource(pipeline.getOptions(), referenceName, BaseRecalibratorDataflow.BQSR_REFERENCE_WINDOW_FUNCTION);
